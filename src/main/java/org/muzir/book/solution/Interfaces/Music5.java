...
class Wind extends CommonBase implements Instrument {
...
class Percussion extends CommonBase implements Instrument {
	public void play(Note n) {
		print(this + ".play() " + n);
	}
...
class Stringed extends CommonBase implements Instrument {
	public void play(Note n) {
		print(this + ".play() " + n);
	}
